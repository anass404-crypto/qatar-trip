...
const day0 = {
  ...
  items: [
    ...
    { id: "d0-10", time: "17:20", type: "split", title: "انقسام المسارات",
      paths: [
        ...
        { key: "adults", label: "الكبار", icon: "🧑", items: [
          { id: "d0-10-adults-1", time: "17:45", timeEnd: "18:05", title: "مكتبة قطر الوطنية", category: "book",
            desc: "تغلق 8:00 م.",
            mapsUrl: "https://maps.google.com/?q=place_id:ChIJuQfI1QfcRT4R4wy5B5LpX3g",
            highlights: ["تغلق الساعة 8:00 م"] },
          { id: "d0-10-adults-2", time: "18:10", approx: true, timeEnd: null, title: "صلاة المغرب في مسجد المدينة التعليمية", category: "culture",
            desc: "ثم الترام والحديقة القرآنية.", highlights: [] },
          { id: "d0-10-adults-3", time: "19:40", approx: true, timeEnd: null, title: "صلاة العشاء", category: "culture",
            desc: "", highlights: [] },
        ]},
      ],
    },
    { id: "d0-11", time: "20:00", timeEnd: "21:30", title: "العشاء في قصر الياسمين", category: "food",
    ...
    { id: "d0-12", time: "21:45", timeEnd: null, title: "الفندق", category: "hotel", desc: "", highlights: [] },
  ],
};
...
const day1 = {
  ...
  items: [
    ...
    { id: "d1-3", time: "12:15", timeEnd: "13:15", title: "غداء خفيف قرب الفندق", category: "food", desc: "", highlights: [] },
    { id: "d1-4", time: "13:40", timeEnd: null, title: "الوصول إلى Doha Quest", category: "ride",
    ...
    { id: "d1-5", time: "14:00", timeEnd: "22:00", title: "Doha Quest", category: "ride", cover: "dohaQuest",
      ...
      innerPlan: [
        { time: "14:00", label: "الألعاب الكبيرة أولًا" },
        { time: "16:30", label: "استراحة" },
        { time: "17:00", label: "التحديات العائلية" },
        { time: "19:00", label: "العشاء داخل Quest" },
        { time: "20:00", label: "إعادة الألعاب المفضلة" },
        { time: "21:30", label: "الهدايا" },
      ],
      highlights: ["اليوم الرئيسي في الرحلة", "خطة كاملة من الصباح للمساء"] },
    { id: "d1-6", time: "22:15", timeEnd: null, title: "الفندق", category: "hotel", desc: "", highlights: [] },
  ],
};
...
const day2 = {
  ...
  items: [
    ...
    { id: "d2-11", time: "22:00", timeEnd: null, title: "الفندق — تجهيز الحقائب", category: "hotel", desc: "", highlights: [] },
  ],
};
