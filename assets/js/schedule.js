...
import { DAYS, TRIP, CATEGORY_STYLE, REAL_PHOTOS, HIGHLIGHT_IDS } from "./data.js?v=21";
import { timeToDate } from "./util.js?v=21";
import { getActivityOverride, getActivityStatus } from "./store.js?v=21";
