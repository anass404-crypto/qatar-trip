...
import { DAYS, TRIP, CATEGORY_STYLE, REAL_PHOTOS, HIGHLIGHT_IDS } from "./data.js?v=7";
import { timeToDate } from "./util.js?v=7";
import { getActivityOverride, getActivityStatus } from "./store.js?v=7";
