...
import { DAYS, TRIP, CATEGORY_STYLE, REAL_PHOTOS, HIGHLIGHT_IDS } from "./data.js?v=10";
import { timeToDate } from "./util.js?v=10";
import { getActivityOverride, getActivityStatus } from "./store.js?v=10";
