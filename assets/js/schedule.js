...
import { DAYS, TRIP, CATEGORY_STYLE, REAL_PHOTOS, HIGHLIGHT_IDS } from "./data.js?v=16";
import { timeToDate } from "./util.js?v=16";
import { getActivityOverride, getActivityStatus } from "./store.js?v=16";
