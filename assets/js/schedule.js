...
import { DAYS, TRIP, CATEGORY_STYLE, REAL_PHOTOS, HIGHLIGHT_IDS } from "./data.js?v=15";
import { timeToDate } from "./util.js?v=15";
import { getActivityOverride, getActivityStatus } from "./store.js?v=15";
