import { DAYS, TRIP, REAL_PHOTOS } from "../data.js?v=21";
import { el, ar, formatCountdown } from "../util.js?v=21";
import {
...
import { renderTimeline } from "./timeline.js?v=21";
import { openActivitySheet } from "./activitySheet.js?v=21";
import { isTeaserDismissed, dismissTeaser } from "../store.js?v=21";
